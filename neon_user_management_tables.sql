...
-- Create candidates table for recruitment process
...
INSERT INTO candidates (
    ...
    ('FSDT1R1', 'AKASH', 'vojjid7905@lanije.com', '7411623375', 'Senior Software Engineer', 3.0, 3.0, 'Technical - T1', 'PENDING', 'recruiter@aria.com', NOW(), NOW());
...
INSERT INTO candidate_skills (candidate_id, skill) VALUES 
    ...
    (4, 'Java'), (4, 'Spring Boot'), (4, 'React'), (4, 'PostgreSQL');
